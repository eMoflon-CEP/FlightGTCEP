...
public class Route_src_0_reference extends AbstractActor {
	...
	public Route_src_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("replacmentConnectingFlight_10_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("replacmentConnectingFlight_19_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("travelHasConnectingFlight_53_junction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<Flights.Route> message) {
		...
		Flights.Airport target = (Flights.Airport) message.input.getSrc();
