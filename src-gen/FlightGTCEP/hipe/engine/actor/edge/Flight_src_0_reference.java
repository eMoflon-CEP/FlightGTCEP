...
public class Flight_src_0_reference extends AbstractActor {
	...
	public Flight_src_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("replacmentConnectingFlight_38_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("travelHasConnectingFlight_58_junction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<Flights.Flight> message) {
		...
		Flights.Gate target = (Flights.Gate) message.input.getSrc();
