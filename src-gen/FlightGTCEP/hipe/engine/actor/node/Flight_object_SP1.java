...
public class Flight_object_SP1 extends AbstractActor {
	
	private List<Port<Flights.Flight>> ports;		
		
	public Flight_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeLeft<Flights.Flight>(getSelf(), name2actor.get("Flight_route_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<Flights.Flight>(getSelf(), name2actor.get("Travel_flights_0_reference"), this::returnTrue));
	}
